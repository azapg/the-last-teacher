  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // Force a high-contrast tooltip in light mode using our CSS vars explicitly.
          // Using arbitrary values avoids relying on theme key mapping.
      ...
      >
        {children}
        {/* Use the SVG arrow with proper fill; no rotation hack so it renders correctly. */}
        <TooltipPrimitive.Arrow className="z-50 size-2 fill-[hsl(var(--primary))]" />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
}
